...
final class Paladin extends Specialization {
  ...
  String classExtraDescription(ClassExtras extra) => {
        ClassExtras.godFeeling: '''Вы чувствуете присутствие сил добра и зла.
...
Это умение не оказывает никакого эффекта на Нежить и Конструктов.''',
  ...
  final List<ClassExtras> classExtras = [
    ClassExtras.layingOfHands,
    ClassExtras.godFeeling,
  ];

  @override
  int getClassExtrasCount(Player player, ClassExtras extra) => {
        ClassExtras.godFeeling: 1 + player.charisma.bonus,
        ClassExtras.layingOfHands: player.level * 5,
      }[extra]!;
      ...
      Paladin._(
        ...
        baseAbilities: [
          ...
          Peculiarity(
            ...
            description:
                '''Если вы попадаете по существу рукопашной атакой оружием, вы можете потратить одну ячейку заклинаний любого своего класса для причинения цели урона излучением, который добавится к урону от оружия. Дополнительный урон равен <b>2к8</b> за ячейку 1-го уровня и ещё 1к8 за каждый уровень ячейки выше первого до максимума в <b>5к8</b>. Если цель — Нежить или Исчадие, урон увеличивается на <b>1к8</b> с максимумом <b>6к8</b>.''',
            dicePerLevel: 1,
            startDiceCount: 1,
            maxDiceCount: 5,
            valueDice: Dice.k8,
            magicDescription: '''Базовый урон: <b>1к8</b>.''',
          ),
        ],
